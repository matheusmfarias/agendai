...
function PanelShell({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-50 flex h-[92dvh] w-full sm:inset-y-0 sm:left-auto sm:right-0 sm:h-auto sm:w-[min(100vw,38rem)] lg:w-[36rem] xl:w-[38rem]">
      <aside
