...
export function DashboardSidebar({
  ...
  const activeHref = routeTransition.href
    ? pathnameFromHref(routeTransition.href)
    : findActiveHref(pathname, navigation);
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={cn(
            "shrink-0 border-t border-border p-3 transition-[padding] duration-300",
            ...
            >
              ...
              >
                ...
                <form action={logoutAction} className="shrink-0">
                  <button
                    type="submit"
                    className="grid size-8 cursor-pointer place-items-center rounded-xl text-muted-foreground transition-colors hover:bg-background hover:text-primary"
                    title="Sair"
                  >
