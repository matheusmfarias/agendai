...
const SPECIFIC_MESSAGES: Record<string, string> = {
  ...
  "service-created": "Servico cadastrado com sucesso.",
  "service-updated": "Servico atualizado com sucesso.",
  "service-status": "Status do servico atualizado.",
  "category-created": "Categoria criada. Agora cadastre o primeiro servico.",
